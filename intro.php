        ...
        <p>
            ...
            <br><br>
            Vous pouvez naviguer à travers ce petit site internet que j'ai réalisé pour découvrir mon parcour avant de commencer cette formation ! <br>
            <br>
            Pour changer de background (vider le cache pour éviter les répétitions de fonds avec ctrl+r+shift) : </div>
            <button class="change" type="button" id="change" value="1" onclick="changeClass()" 
                style="border:none; background-color:transparent; pointer-events: auto;"> 
