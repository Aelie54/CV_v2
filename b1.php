                ...
                <div class="contain" style="background-color:white;">
                    ...
                    <p><span class= "gras">BAC+2 Physique Chimie</span> <br>Faculté des Sciences de Nancy (2014)</p> 
                    <p><span class= "gras">Baccalauréat Scientifique</span><br>Lycée Pierre Mendès France à Epinal (2010) </p> <br>
                </div>

                
                <button class="favorite styled"
        type="button" id="retour" onclick="run5()">
    Add to favorites
</button>